...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (mobileNavToggle) {
    mobileNavToggle.addEventListener('click', function(e) {
      ...
      // Опционально добавляем overlay на body
      body.classList.toggle('mobile-nav-active');
    });
    
    // Обработчик нажатия на пункты меню (для закрытия после выбора на мобильных)
    document.querySelectorAll('#navmenu a').forEach(function(navItem) {
